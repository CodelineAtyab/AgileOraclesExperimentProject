...
,p_release=>'26.1.0'
,p_default_workspace_id=>7758067673032259
...
prompt APPLICATION 101 - Hospital Management System
--
-- Application Export:
--   Application:     101
--   Name:            Hospital Management System
--   Date and Time:   04:41 Tuesday July 21, 2026
--   Exported By:     ADMIN
--   Flashback:       0
...
,p_checksum_salt=>'7CEC0FE78CB2E786B7FB7D1C3E64862C78815651DFA33E5F44CFA1BFD13C184D'
...
,p_authentication_id=>wwv_flow_imp.id(7765811667241124)
...
,p_created_on=>wwv_flow_imp.dz('20260713053439Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260721044103Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
,p_file_prefix=>nvl(wwv_flow_application_install.get_static_app_file_prefix,'')
,p_files_version=>2461235053440
,p_version_scn=>'7487427'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(7766765638241136)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2469215554099805162
,p_nav_list_template_options=>'#DEFAULT#:t-TreeNav--styleA:js-navCollapsed--hidden'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(7767558234241228)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7763267306241111)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>'SH256:NcagEyRP_F17oe14bnrSYSYienkBgpdRSvH17g_NxoE'
,p_created_on=>wwv_flow_imp.dz('20260713053439Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053439Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7762031453241109)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7763572172241111)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7763863205241112)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7761792577241108)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7765309129241114)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7762330578241109)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7762697175241110)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7765042853241114)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7762999803241110)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7761490942241090)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7764103535241112)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7764735532241113)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(7764412650241113)
,p_plugin_type=>'WEB SOURCE TYPE'
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(7767558234241228)
,p_name=>'Navigation Bar'
,p_static_id=>'navigation-bar'
,p_version_scn=>'SH256:vnb1-G39r80BPE-5P2Enpuf0sMSVvBeNQDVbFiNwRto'
,p_created_on=>wwv_flow_imp.dz('20260713053440Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053441Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(7780784614241334)
...
,p_created_on=>wwv_flow_imp.dz('20260713053441Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053441Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(7781324817241336)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'---'
,p_static_id=>'list_item'
,p_list_item_link_target=>'separator'
,p_list_item_disp_cond_type=>'USER_IS_NOT_PUBLIC_USER'
,p_parent_list_item_id=>wwv_flow_imp.id(7780784614241334)
,p_list_item_current_type=>'TARGET_PAGE'
,p_created_on=>wwv_flow_imp.dz('20260713053441Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053441Z')
,p_created_by=>'ADMIN'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(7781861008241340)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(7766765638241136)
,p_name=>'Navigation Menu'
,p_static_id=>'navigation-menu'
,p_version_scn=>'SH256:AyTYKtipMxtOf8JBIzmV0V1wg41ORfM-sR3nvCao0tE'
,p_created_on=>wwv_flow_imp.dz('20260713053439Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144650Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8749755364006168)
...
,p_created_on=>wwv_flow_imp.dz('20260715131956Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144640Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8724500309768433)
...
,p_created_on=>wwv_flow_imp.dz('20260715124019Z')
,p_updated_on=>wwv_flow_imp.dz('20260715124019Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8140269847387555)
...
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_updated_on=>wwv_flow_imp.dz('20260714082551Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8668130737458752)
...
,p_created_on=>wwv_flow_imp.dz('20260715081313Z')
,p_updated_on=>wwv_flow_imp.dz('20260715081313Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8777540768354826)
...
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144616Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(7809095764356545)
,p_list_item_display_sequence=>30
...
,p_created_on=>wwv_flow_imp.dz('20260713055353Z')
,p_updated_on=>wwv_flow_imp.dz('20260714082133Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8017325857217859)
...
,p_created_on=>wwv_flow_imp.dz('20260713123651Z')
,p_updated_on=>wwv_flow_imp.dz('20260714082525Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8006983931947809)
...
,p_created_on=>wwv_flow_imp.dz('20260713114720Z')
,p_updated_on=>wwv_flow_imp.dz('20260714082506Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8744183616985432)
...
,p_created_on=>wwv_flow_imp.dz('20260715131629Z')
,p_updated_on=>wwv_flow_imp.dz('20260715131629Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8702566920385465)
,p_list_item_display_sequence=>140
,p_list_item_link_text=>'Patient Admission Screen'
,p_static_id=>'patient-admission-screen'
,p_list_item_link_target=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-hospital-o'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'15'
,p_created_on=>wwv_flow_imp.dz('20260715113534Z')
,p_updated_on=>wwv_flow_imp.dz('20260715121617Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(7964648119702379)
...
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_updated_on=>wwv_flow_imp.dz('20260714082412Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8405097112499205)
...
,p_created_on=>wwv_flow_imp.dz('20260714113318Z')
,p_updated_on=>wwv_flow_imp.dz('20260715072553Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8734774079887156)
...
,p_created_on=>wwv_flow_imp.dz('20260715130006Z')
,p_updated_on=>wwv_flow_imp.dz('20260715130006Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8464939092289420)
,p_list_item_display_sequence=>120
,p_list_item_link_text=>'Visit & Prescription Management'
,p_static_id=>'visit-prescription-management'
,p_list_item_link_target=>'f?p=&APP_ID.:13:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-media-list'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'13'
,p_created_on=>wwv_flow_imp.dz('20260715045821Z')
,p_updated_on=>wwv_flow_imp.dz('20260715045821Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(7768928932241251)
,p_file_name=>'icons/app-icon-144-rounded.png'
,p_mime_type=>'image/png'
,p_file_charset=>'utf-8'
,p_file_content=>wwv_flow_imp.varchar2_to_blob(wwv_flow_imp.g_varchar2_table)
,p_created_on=>wwv_flow_imp.dz('20260713053440Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053440Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(7769264723241255)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(7769518011241255)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(7768658605241248)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(7769802614241256)
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(7771174344241259)
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8132396122387547)
...
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_updated_on=>wwv_flow_imp.dz('20260714070822Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(7779622811241326)
,p_lov_name=>'BOOLEAN'
,p_static_id=>'boolean'
,p_lov_query=>'.'||wwv_flow_imp.id(7779622811241326)||'.'
,p_location=>'STATIC'
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(7780384106241334)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(7779918536241331)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8768153565354803)
...
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141802Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8768863265354814)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8130828128387545)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8130172795387539)
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(7771452371241263)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(7766222135241130)
,p_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_created_on=>wwv_flow_imp.dz('20260713053439Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144411Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8750726053006170)
,p_short_name=>'Admission Report'
,p_static_id=>'admission-report'
,p_link=>'f?p=&APP_ID.:19:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>19
,p_created_on=>wwv_flow_imp.dz('20260715131956Z')
,p_updated_on=>wwv_flow_imp.dz('20260715131956Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8725594389768444)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8146627161387842)
,p_short_name=>'Appointments'
,p_static_id=>'appointments'
,p_link=>'f?p=&APP_ID.:10:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>10
,p_created_on=>wwv_flow_imp.dz('20260714070825Z')
,p_updated_on=>wwv_flow_imp.dz('20260714070825Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8669127422458773)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8784049903354987)
,p_short_name=>'Doctor Management'
,p_static_id=>'doctor-management'
,p_link=>'f?p=&APP_ID.:5:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>5
,p_created_on=>wwv_flow_imp.dz('20260715141804Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141804Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8759154638197273)
,p_short_name=>'Home'
,p_static_id=>'home'
,p_link=>'f?p=&APP_ID.:1:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1
,p_created_on=>wwv_flow_imp.dz('20260715135147Z')
,p_updated_on=>wwv_flow_imp.dz('20260715135147Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(7810090542356555)
,p_short_name=>'Home Dashboard'
,p_static_id=>'home-dashboard'
,p_link=>'f?p=&APP_ID.:2:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>2
,p_created_on=>wwv_flow_imp.dz('20260713055353Z')
,p_updated_on=>wwv_flow_imp.dz('20260713055353Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8018359911217863)
,p_short_name=>'Low Stock Medicines'
,p_static_id=>'low-stock-medicines'
,p_link=>'f?p=&APP_ID.:9:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>9
,p_created_on=>wwv_flow_imp.dz('20260713123651Z')
,p_updated_on=>wwv_flow_imp.dz('20260713123651Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8013415056947958)
,p_short_name=>'Medicine Management'
,p_static_id=>'medicine-management'
,p_link=>'f?p=&APP_ID.:7:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>7
,p_created_on=>wwv_flow_imp.dz('20260713114721Z')
,p_updated_on=>wwv_flow_imp.dz('20260713114721Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8745195692985434)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8703445154385494)
,p_short_name=>'Patient Admission Screen'
,p_static_id=>'patient-admission-screen'
,p_link=>'f?p=&APP_ID.:15:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>15
,p_created_on=>wwv_flow_imp.dz('20260715113534Z')
,p_updated_on=>wwv_flow_imp.dz('20260715113534Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(7972619106702552)
,p_short_name=>'Patient Management'
,p_static_id=>'patient-management'
,p_link=>'f?p=&APP_ID.:3:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>3
,p_created_on=>wwv_flow_imp.dz('20260713110628Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110628Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8735774797887159)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8465963434289434)
,p_short_name=>'Visit &amp; Prescription Management'
,p_static_id=>'visit-amp-prescription-management'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(7767137305241151)
,p_theme_id=>42
...
,p_created_on=>wwv_flow_imp.dz('20260713053439Z')
,p_updated_on=>wwv_flow_imp.dz('20260713073237Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(7765509462241114)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(7765811667241124)
...
,p_created_on=>wwv_flow_imp.dz('20260713053440Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260713053440Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
end;
...
,p_created_on=>wwv_flow_imp.dz('20260715135147Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715135147Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8758510050197271)
...
,p_menu_id=>wwv_flow_imp.id(7766222135241130)
...
,p_created_on=>wwv_flow_imp.dz('20260713055353Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260713075931Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7863535789762809)
...
,p_created_on=>wwv_flow_imp.dz('20260713071640Z')
,p_updated_on=>wwv_flow_imp.dz('20260713072316Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(7863693395762810)
,p_region_id=>wwv_flow_imp.id(7863535789762809)
,p_layout_type=>'GRID'
,p_title_adv_formatting=>false
,p_title_column_name=>'ACTIVE_DOCTORS'
,p_sub_title_adv_formatting=>false
,p_body_adv_formatting=>false
,p_second_body_adv_formatting=>false
,p_media_adv_formatting=>false
,p_pk1_column_name=>'ACTIVE_DOCTORS'
,p_updated_on=>wwv_flow_imp.dz('20260713071640Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7809499420356552)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7810293117356676)
...
,p_created_on=>wwv_flow_imp.dz('20260713055355Z')
,p_updated_on=>wwv_flow_imp.dz('20260713062408Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(7810543987356678)
,p_region_id=>wwv_flow_imp.id(7810293117356676)
,p_chart_type=>'pie'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(7812200036356681)
,p_chart_id=>wwv_flow_imp.id(7810543987356678)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7812891221356801)
...
'ORDER BY VALUE DESC'))
,p_plug_source_type=>'NATIVE_JET_CHART'
,p_created_on=>wwv_flow_imp.dz('20260713055356Z')
,p_updated_on=>wwv_flow_imp.dz('20260713071432Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(7813111058356806)
,p_region_id=>wwv_flow_imp.id(7812891221356801)
,p_chart_type=>'bar'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(7813605247356807)
,p_chart_id=>wwv_flow_imp.id(7813111058356806)
,p_static_id=>'series-1'
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(7863195266762805)
,p_chart_id=>wwv_flow_imp.id(7813111058356806)
,p_static_id=>'x'
,p_axis=>'x'
,p_is_rendered=>'on'
...
,p_created_on=>wwv_flow_imp.dz('20260713070306Z')
,p_updated_on=>wwv_flow_imp.dz('20260713070437Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(7863271821762806)
,p_chart_id=>wwv_flow_imp.id(7813111058356806)
,p_static_id=>'y'
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'Number of appointments'
...
,p_tick_label_rendered=>'on'
,p_created_on=>wwv_flow_imp.dz('20260713070306Z')
,p_updated_on=>wwv_flow_imp.dz('20260713070502Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7814229990356925)
...
'       COUNT(a.ADMISSION_ID) AS VALUE',
'FROM ADMISSIONS a',
'JOIN ROOMS r ON a.ROOM_ID = r.ROOM_ID',
'WHERE a.STATUS = ''Admitted''',
'GROUP BY r.ROOM_TYPE'))
,p_plug_source_type=>'NATIVE_JET_CHART'
,p_created_on=>wwv_flow_imp.dz('20260713055357Z')
,p_updated_on=>wwv_flow_imp.dz('20260713073225Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(7814570451356927)
,p_region_id=>wwv_flow_imp.id(7814229990356925)
,p_chart_type=>'donut'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
,p_pie_selection_effect=>'highlight'
,p_created_on=>wwv_flow_imp.dz('20260713055357Z')
,p_updated_on=>wwv_flow_imp.dz('20260713073107Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(7816235183356934)
,p_chart_id=>wwv_flow_imp.id(7814570451356927)
,p_static_id=>'series-1'
,p_seq=>10
,p_name=>'Type'
,p_data_source_type=>'SQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7863706431762811)
,p_plug_name=>'Current Admissions '
,p_static_id=>'current-admissions'
,p_title=>'Current Admissions '
,p_parent_plug_id=>wwv_flow_imp.id(7814229990356925)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
,p_plug_display_sequence=>10
,p_plug_new_grid_row=>false
...
,p_plug_query_num_rows_type=>'SCROLL'
,p_show_total_row_count=>false
,p_created_on=>wwv_flow_imp.dz('20260713072424Z')
,p_updated_on=>wwv_flow_imp.dz('20260713072916Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(7863865011762812)
,p_region_id=>wwv_flow_imp.id(7863706431762811)
,p_layout_type=>'GRID'
,p_title_adv_formatting=>false
,p_title_column_name=>'CURRENT_ADMISSIONS'
,p_sub_title_adv_formatting=>false
,p_body_adv_formatting=>false
,p_second_body_adv_formatting=>false
,p_media_adv_formatting=>false
,p_pk1_column_name=>'CURRENT_ADMISSIONS'
,p_updated_on=>wwv_flow_imp.dz('20260713072558Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7863911879762813)
...
,p_plug_query_num_rows_type=>'SCROLL'
,p_show_total_row_count=>false
,p_created_on=>wwv_flow_imp.dz('20260713073343Z')
,p_updated_on=>wwv_flow_imp.dz('20260713073511Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(7864058884762814)
,p_region_id=>wwv_flow_imp.id(7863911879762813)
,p_layout_type=>'GRID'
,p_title_adv_formatting=>false
,p_title_column_name=>'LOW_STOCK_MEDICINES'
,p_sub_title_adv_formatting=>false
,p_body_adv_formatting=>false
,p_second_body_adv_formatting=>false
,p_media_adv_formatting=>false
,p_pk1_column_name=>'LOW_STOCK_MEDICINES'
,p_updated_on=>wwv_flow_imp.dz('20260713073448Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(6977336678069840)
,p_plug_name=>'Total No. of Patients'
,p_static_id=>'patients'
,p_title=>' Total No. of Patients'
,p_parent_plug_id=>wwv_flow_imp.id(7810293117356676)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
,p_plug_query_num_rows_type=>'SCROLL'
,p_show_total_row_count=>false
,p_created_on=>wwv_flow_imp.dz('20260713063909Z')
,p_updated_on=>wwv_flow_imp.dz('20260713072952Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(6977473346069841)
,p_region_id=>wwv_flow_imp.id(6977336678069840)
,p_layout_type=>'GRID'
,p_title_adv_formatting=>false
,p_title_column_name=>'TOTAL_PATIENTS'
,p_sub_title_adv_formatting=>false
,p_body_adv_formatting=>false
,p_second_body_adv_formatting=>false
,p_media_adv_formatting=>false
,p_pk1_column_name=>'TOTAL_PATIENTS'
,p_updated_on=>wwv_flow_imp.dz('20260713070814Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7863305849762807)
,p_plug_name=>'Total No. of Appointments'
,p_static_id=>'patients_1'
,p_title=>'Total No. of Appointments'
,p_parent_plug_id=>wwv_flow_imp.id(7812891221356801)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
,p_plug_query_num_rows_type=>'SCROLL'
,p_show_total_row_count=>false
,p_created_on=>wwv_flow_imp.dz('20260713070437Z')
,p_updated_on=>wwv_flow_imp.dz('20260713072952Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(7863455615762808)
,p_region_id=>wwv_flow_imp.id(7863305849762807)
,p_layout_type=>'GRID'
,p_title_adv_formatting=>false
,p_title_column_name=>'TODAYS_APPOINTMENTS'
,p_sub_title_adv_formatting=>false
,p_body_adv_formatting=>false
,p_second_body_adv_formatting=>false
,p_media_adv_formatting=>false
,p_pk1_column_name=>'TODAYS_APPOINTMENTS'
,p_updated_on=>wwv_flow_imp.dz('20260713070827Z')
,p_updated_by=>'ADMIN'
);
end;
/
...
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260713110715Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7972741828702552)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7965008699702506)
...
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260713110627Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110715Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(7965167506702506)
...
,p_detail_link=>'f?p=&APP_ID.:4:&APP_SESSION.::&DEBUG.:RP:P4_PATIENT_ID:\#PATIENT_ID#\'
,p_detail_link_text=>'<span role="img" aria-label="Edit" class="fa fa-edit" title="Edit"></span>'
,p_internal_uid=>7965167506702506
,p_created_on=>wwv_flow_imp.dz('20260713110627Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110715Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7969463020702540)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7865513153762829)
...
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260713110715Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110715Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7969013832702538)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7966722396702528)
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260713110627Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110627Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7970626678702545)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7967944791702533)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7968759787702537)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7969885354702542)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7970251160702543)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7967185333702530)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7967575672702532)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7968339055702535)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7966353698702521)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(7973313365703752)
...
,p_created_on=>wwv_flow_imp.dz('20260713110640Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110640Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7971006489702547)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(7965008699702506)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(7971480623702547)
,p_name=>'Edit Report - Dialog Closed'
,p_static_id=>'edit-report-dialog-closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(7965008699702506)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(7971841903702549)
,p_event_id=>wwv_flow_imp.id(7971480623702547)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(7965008699702506)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715132958Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7960569745702373)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
...
,p_plug_item_display_point=>'ABOVE'
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110626Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7951765395702362)
,p_plug_name=>'Patient Management Form'
,p_static_id=>'patient-management-form'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7960996129702373)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(7960569745702373)
...
wwv_flow_imp_page.create_component_da_action(
 p_id=>wwv_flow_imp.id(7961436770702375)
,p_button_id=>wwv_flow_imp.id(7960996129702373)
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7962786427702377)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7961920969702377)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7962375812702377)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7955325568702369)
,p_name=>'P4_ADDRESS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(7951765395702362)
,p_item_source_plug_id=>wwv_flow_imp.id(7951765395702362)
,p_prompt=>'Address'
,p_source=>'ADDRESS'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7954944286702369)
...
,p_lov=>'STATIC:O+;O+,O-;O-,A+;A+,A-;A-,B+;B+,B-;B-,AB-;AB+'
...
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_updated_on=>wwv_flow_imp.dz('20260715132958Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7952522010702367)
,p_name=>'P4_CIVIL_ID'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7953712930702368)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7954595756702369)
,p_name=>'P4_EMAIL'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(7951765395702362)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7955705204702370)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7956128049702370)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7952996325702368)
,p_name=>'P4_FULL_NAME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7953308221702368)
,p_name=>'P4_GENDER'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>40
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_updated_on=>wwv_flow_imp.dz('20260713111339Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7954134208702368)
,p_name=>'P4_MOBILE_NO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>60
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7952102112702363)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(7865930929762833)
...
'         WHERE CIVIL_ID = :P3_CIVIL_ID',
'         AND PATIENT_ID != NVL(:P3_PATIENT_ID, -1)',
'     )'))
,p_validation2=>'SQL'
,p_validation_type=>'EXPRESSION'
,p_error_message=>'This Civil ID is already registered to another patient.'
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_imp.id(7952522010702367)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_created_on=>wwv_flow_imp.dz('20260713112115Z')
,p_updated_on=>wwv_flow_imp.dz('20260713112115Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(7865881649762832)
,p_validation_name=>'Mobile Number Required'
,p_static_id=>'mobile-number-required'
,p_validation_sequence=>10
,p_validation=>'P4_MOBILE_NO'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Mobile number is required.'
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_imp.id(7954134208702368)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_created_on=>wwv_flow_imp.dz('20260713112026Z')
,p_updated_on=>wwv_flow_imp.dz('20260713112115Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7963979758702378)
...
,p_internal_uid=>7963979758702378
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110626Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7963179507702377)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(7951765395702362)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Patient Management Form'
,p_static_id=>'initialize-form-patient-management-form'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'current_row_total_item', '',
  'next_primary_key_items', '',
  'previous_primary_key_items', '')).to_clob
,p_internal_uid=>7963179507702377
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110626Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7963543594702378)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(7951765395702362)
,p_process_type=>'NATIVE_FORM_DML'
,p_process_name=>'Process form Patient Management Form'
,p_static_id=>'process-form-patient-management-form'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>7963543594702378
,p_created_on=>wwv_flow_imp.dz('20260713110626Z')
,p_updated_on=>wwv_flow_imp.dz('20260713110626Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
,p_page_component_map=>'18'
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715141913Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8784187368354988)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8777915174354950)
...
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260715141804Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141913Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8778010529354950)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:XLSX:PDF'
,p_enable_mail_download=>'Y'
,p_detail_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:RP:P6_DOCTOR_ID:\#DOCTOR_ID#\'
,p_detail_link_text=>'<span role="img" aria-label="Edit" class="fa fa-edit" title="Edit"></span>'
,p_internal_uid=>8778010529354950
,p_created_on=>wwv_flow_imp.dz('20260715141804Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141913Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8781657870354980)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8711507696496529)
...
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715141824Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141824Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8779261278354964)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8781272341354978)
,p_db_column_name=>'EMAIL'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Email'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8779690773354970)
,p_db_column_name=>'FULL_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Full Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8780870169354977)
,p_db_column_name=>'MOBILE_NO'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Mobile No'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8711697622496530)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8782076462354981)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8786103391361871)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'primary'
,p_status=>'PUBLIC'
...
,p_created_on=>wwv_flow_imp.dz('20260715141913Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141913Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8782417430354983)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8777915174354950)
,p_button_name=>'CREATE'
,p_static_id=>'create'
,p_show_as_disabled=>false
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8782834665354984)
,p_name=>'Edit Report - Dialog Closed'
,p_static_id=>'edit-report-dialog-closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8777915174354950)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
,p_created_on=>wwv_flow_imp.dz('20260715141804Z')
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8783208975354985)
,p_event_id=>wwv_flow_imp.id(8782834665354984)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-refresh'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8777915174354950)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715141804Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141804Z')
...
,p_page_component_map=>'02'
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260721044006Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8773442509354819)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2127905476394690047
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8766853139354788)
,p_plug_name=>'Doctor Management Form'
,p_static_id=>'doctor-management-form'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4502917002193490937
,p_plug_display_sequence=>10
,p_plug_item_display_point=>'ABOVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8773832572354819)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8773442509354819)
,p_button_name=>'CANCEL'
,p_static_id=>'cancel'
,p_show_as_disabled=>false
,p_button_action=>'DEFINED_BY_DA_ACTION'
...
wwv_flow_imp_page.create_component_da_action(
 p_id=>wwv_flow_imp.id(8774371156354821)
,p_button_id=>wwv_flow_imp.id(8773832572354819)
,p_action_sequence=>10
,p_action=>'NATIVE_DIALOG_CANCEL'
,p_static_id=>'native-dialog-cancel'
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8775662919354823)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(8773442509354819)
,p_button_name=>'CREATE'
,p_static_id=>'create'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8774808265354823)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8773442509354819)
,p_button_name=>'DELETE'
,p_static_id=>'delete'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8775213482354823)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(8773442509354819)
,p_button_name=>'SAVE'
,p_static_id=>'save'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8770226050354816)
,p_name=>'P6_CONSULTATION_FEE'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(8766853139354788)
,p_item_source_plug_id=>wwv_flow_imp.id(8766853139354788)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8768034527354801)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_updated_on=>wwv_flow_imp.dz('20260721044005Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8767236568354795)
,p_name=>'P6_DOCTOR_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_is_query_only=>true
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8769844550354816)
,p_name=>'P6_EMAIL'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(8766853139354788)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8767668735354801)
,p_name=>'P6_FULL_NAME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8769476921354815)
,p_name=>'P6_MOBILE_NO'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>50
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8768741622354814)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_updated_on=>wwv_flow_imp.dz('20260721044006Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8770640640354817)
,p_name=>'P6_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>80
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_updated_on=>wwv_flow_imp.dz('20260715142114Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8776827960354825)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
,p_process_when=>'CREATE,SAVE,DELETE'
,p_process_when_type=>'REQUEST_IN_CONDITION'
,p_internal_uid=>8776827960354825
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141802Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8776096919354824)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(8766853139354788)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Doctor Management Form'
,p_static_id=>'initialize-form-doctor-management-form'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'current_row_total_item', '',
  'next_primary_key_items', '',
  'previous_primary_key_items', '')).to_clob
,p_internal_uid=>8776096919354824
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141802Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8776452542354825)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(8766853139354788)
,p_process_type=>'NATIVE_FORM_DML'
,p_process_name=>'Process form Doctor Management Form'
,p_static_id=>'process-form-doctor-management-form'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
  'target_type', 'REGION_SOURCE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8776452542354825
,p_created_on=>wwv_flow_imp.dz('20260715141802Z')
,p_updated_on=>wwv_flow_imp.dz('20260715141802Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
,p_page_component_map=>'02'
,p_created_on=>wwv_flow_imp.dz('20260713114720Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715144114Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8013554779947958)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8007374028947936)
...
'           THEN ''<span style="color:#c0392b; font-weight:bold;">'' || m.MEDICINE_NAME || ''</span>''',
'           ELSE m.MEDICINE_NAME',
...
'       CASE ',
'           WHEN m.CURRENT_STOCK < m.REORDER_LEVEL ',
'           THEN ''<span class="t-Badge t-Badge--danger">Low Stock</span>''',
'           ELSE ''Adequate''',
'       END AS STOCK_STATUS',
'FROM MEDICINES m',
...
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260713114721Z')
,p_updated_on=>wwv_flow_imp.dz('20260714045227Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8007486117947936)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:XLSX:PDF'
,p_enable_mail_download=>'Y'
,p_detail_link=>'f?p=&APP_ID.:8:&APP_SESSION.::&DEBUG.:RP:P8_MEDICINE_ID:\#MEDICINE_ID#\'
,p_detail_link_text=>'<span role="img" aria-label="Edit" class="fa fa-edit" title="Edit"></span>'
,p_internal_uid=>8007486117947936
,p_created_on=>wwv_flow_imp.dz('20260713114721Z')
,p_updated_on=>wwv_flow_imp.dz('20260714045227Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8009414101947946)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8010290338947949)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8008647285947941)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8009098784947944)
,p_db_column_name=>'MEDICINE_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Medicine Name'
,p_column_html_expression=>'#MEDICINE_NAME#'
,p_column_type=>'STRING'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8010689111947951)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8011039148947953)
,p_db_column_name=>'STATUS'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8011416536947954)
,p_db_column_name=>'STOCK_STATUS'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Stock Status'
,p_column_html_expression=>'#STOCK_STATUS#'
,p_column_type=>'STRING'
,p_display_text_as=>'WITHOUT_MODIFICATION'
,p_heading_alignment=>'LEFT'
,p_use_as_row_header=>'N'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8009856992947948)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8015362367123754)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'primary'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'MEDICINE_ID:MEDICINE_NAME:CATEGORY_NAME:UNIT:CURRENT_STOCK:REORDER_LEVEL:STATUS:STOCK_STATUS'
,p_created_on=>wwv_flow_imp.dz('20260713122110Z')
,p_updated_on=>wwv_flow_imp.dz('20260714045019Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8011826806947956)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(8007374028947936)
,p_button_name=>'CREATE'
,p_static_id=>'create'
,p_show_as_disabled=>false
,p_button_action=>'REDIRECT_PAGE'
...
,p_created_on=>wwv_flow_imp.dz('20260713114721Z')
,p_updated_on=>wwv_flow_imp.dz('20260713123909Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7866194293762835)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8007374028947936)
,p_button_name=>'Low-Stock-Meds'
,p_static_id=>'new'
,p_show_as_disabled=>false
,p_button_action=>'REDIRECT_PAGE'
...
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Low-stock-meds'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:9:&SESSION.::&DEBUG.:::'
,p_warn_on_unsaved_changes=>null
,p_created_on=>wwv_flow_imp.dz('20260713123740Z')
,p_updated_on=>wwv_flow_imp.dz('20260714043600Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8012208610947956)
,p_name=>'Edit Report - Dialog Closed'
,p_static_id=>'edit-report-dialog-closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8007374028947936)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
,p_created_on=>wwv_flow_imp.dz('20260713114721Z')
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8012697118947956)
,p_event_id=>wwv_flow_imp.id(8012208610947956)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-refresh'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8007374028947936)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260713114721Z')
,p_updated_on=>wwv_flow_imp.dz('20260713114721Z')
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8811737982493981)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_DML'
,p_process_name=>'Process form Doctor Management Form'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'target_type', 'REGION_SOURCE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8811737982493981
,p_created_on=>wwv_flow_imp.dz('20260715144114Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144114Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
wwv_flow_imp_page.create_page(
 p_id=>8
,p_name=>'Medicine Management Form'
,p_alias=>'MEDICINE-MANAGEMENT-FORM'
,p_page_mode=>'MODAL'
,p_step_title=>'Medicine Management Form'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>1662662927374504442
,p_page_template_options=>'#DEFAULT#:js-dialog-class-t-Drawer--pullOutEnd'
,p_dialog_chained=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8002806264947805)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2127905476394690047
...
,p_plug_item_display_point=>'ABOVE'
,p_created_on=>wwv_flow_imp.dz('20260713114720Z')
,p_updated_on=>wwv_flow_imp.dz('20260713114720Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8712745493496541)
,p_plug_name=>'Medicine Management Form'
,p_static_id=>'medicine-management-form'
...
,p_is_editable=>false
,p_plug_source_type=>'NATIVE_FORM'
,p_created_on=>wwv_flow_imp.dz('20260715143741Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144538Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8003271670947806)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8002806264947805)
,p_button_name=>'CANCEL'
,p_static_id=>'cancel'
,p_show_as_disabled=>false
,p_button_action=>'DEFINED_BY_DA_ACTION'
...
wwv_flow_imp_page.create_component_da_action(
 p_id=>wwv_flow_imp.id(8003727767947806)
,p_button_id=>wwv_flow_imp.id(8003271670947806)
,p_action_sequence=>10
,p_action=>'NATIVE_DIALOG_CANCEL'
,p_static_id=>'native-dialog-cancel'
,p_created_on=>wwv_flow_imp.dz('20260713114720Z')
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8005021606947807)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(8002806264947805)
,p_button_name=>'CREATE'
,p_static_id=>'create'
...
,p_button_image_alt=>'Create'
,p_button_position=>'NEXT'
,p_button_condition=>'P8_MEDICINE_ID'
,p_button_condition_type=>'ITEM_IS_NULL'
,p_database_action=>'INSERT'
,p_created_on=>wwv_flow_imp.dz('20260713114720Z')
,p_updated_on=>wwv_flow_imp.dz('20260715143741Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8004231308947806)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8002806264947805)
,p_button_name=>'DELETE'
,p_static_id=>'delete'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8004637700947807)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(8002806264947805)
,p_button_name=>'SAVE'
,p_static_id=>'save'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8713199039496545)
,p_name=>'P8_CATEGORY_ID'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8712745493496541)
,p_item_source_plug_id=>wwv_flow_imp.id(8712745493496541)
,p_prompt=>'Category'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715143741Z')
,p_updated_on=>wwv_flow_imp.dz('20260721044103Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8713359519496547)
,p_name=>'P8_CURRENT_STOCK'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8712745493496541)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8712901970496543)
,p_name=>'P8_MEDICINE_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_is_query_only=>true
,p_item_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8713063577496544)
,p_name=>'P8_MEDICINE_NAME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8712745493496541)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8713400539496548)
,p_name=>'P8_REORDER_LEVEL'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8712745493496541)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8713513694496549)
,p_name=>'P8_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>10
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715143741Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144510Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8713293214496546)
,p_name=>'P8_UNIT'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8006234612947808)
...
,p_process_when=>'CREATE,SAVE,DELETE'
,p_process_when_type=>'REQUEST_IN_CONDITION'
,p_internal_uid=>8006234612947808
,p_created_on=>wwv_flow_imp.dz('20260713114720Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144329Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8712879002496542)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(8712745493496541)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Medicine Management Form'
,p_static_id=>'initialize-form-medicine-management-form'
,p_internal_uid=>8712879002496542
,p_created_on=>wwv_flow_imp.dz('20260715143741Z')
,p_updated_on=>wwv_flow_imp.dz('20260715143741Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8806888553491403)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(8712745493496541)
,p_process_type=>'NATIVE_FORM_DML'
,p_process_name=>'Process form Medicine Management Form'
,p_static_id=>'process-form-medicine-management-form'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'lock_row', 'Y',
  'prevent_lost_updates', 'Y',
  'return_primary_keys_after_insert', 'Y',
  'target_type', 'REGION_SOURCE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8806888553491403
,p_created_on=>wwv_flow_imp.dz('20260715144329Z')
,p_updated_on=>wwv_flow_imp.dz('20260715144329Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
...
,p_page_component_map=>'18'
,p_created_on=>wwv_flow_imp.dz('20260713123651Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260714043541Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8017749021217862)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16047213796411799)
,p_plug_name=>'Low Stock Medicines'
,p_static_id=>'low-stock-medicines-2'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--hideHeader js-addHiddenHeadingRoleDesc'
,p_plug_template=>2102002977963900996
,p_plug_display_sequence=>20
,p_plug_item_display_point=>'ABOVE'
...
'          m.CURRENT_STOCK,',
'          m.REORDER_LEVEL,',
'          (m.REORDER_LEVEL - m.CURRENT_STOCK) AS SHORTAGE_QTY',
'   FROM MEDICINES m',
'   JOIN MEDICINE_CATEGORIES c ON m.CATEGORY_ID = c.CATEGORY_ID',
...
,p_prn_border_color=>'#666666'
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260714043359Z')
,p_updated_on=>wwv_flow_imp.dz('20260714043456Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(16047325885411799)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_detail_link=>'f?p=&APP_ID.:8:&APP_SESSION.::&DEBUG.:RP:P8_MEDICINE_ID:\#MEDICINE_ID#\'
,p_detail_link_text=>'<span role="img" aria-label="Edit" class="fa fa-edit" title="Edit"></span>'
,p_internal_uid=>16047325885411799
,p_created_on=>wwv_flow_imp.dz('20260714043359Z')
,p_updated_on=>wwv_flow_imp.dz('20260714043456Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(16049253869411809)
,p_db_column_name=>'CATEGORY_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Category Name'
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260714043359Z')
,p_updated_on=>wwv_flow_imp.dz('20260714043359Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(16050130106411812)
,p_db_column_name=>'CURRENT_STOCK'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Current Stock'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(16048938552411807)
,p_db_column_name=>'MEDICINE_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Medicine Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(16050528879411814)
,p_db_column_name=>'REORDER_LEVEL'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Reorder Level'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(7866226510762836)
,p_db_column_name=>'SHORTAGE_QTY'
,p_display_order=>16
,p_column_identifier=>'J'
...
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260714043455Z')
,p_updated_on=>wwv_flow_imp.dz('20260714043455Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(16049696760411811)
,p_db_column_name=>'UNIT'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Unit'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(16055202134587617)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'primary'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'MEDICINE_NAME:CATEGORY_NAME:UNIT:CURRENT_STOCK:REORDER_LEVEL'
,p_created_on=>wwv_flow_imp.dz('20260714043359Z')
,p_updated_on=>wwv_flow_imp.dz('20260714043456Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8043916195463905)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(16047213796411799)
,p_button_name=>'Medicine-Management'
,p_static_id=>'low-stock-meds'
,p_show_as_disabled=>false
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>2084305881903810008
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Medicine-management'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:7:&SESSION.::&DEBUG.:::'
,p_warn_on_unsaved_changes=>null
,p_created_on=>wwv_flow_imp.dz('20260714043359Z')
,p_updated_on=>wwv_flow_imp.dz('20260714043541Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
,p_page_component_map=>'18'
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715113056Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8140699823387810)
...
,p_prn_border_color=>'#666666'
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260714070824Z')
,p_updated_on=>wwv_flow_imp.dz('20260715113056Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8140763975387810)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_detail_link_text=>'<span role="img" aria-label="Edit" class="fa fa-edit" title="Edit"></span>'
,p_internal_uid=>8140763975387810
,p_created_on=>wwv_flow_imp.dz('20260714070825Z')
,p_updated_on=>wwv_flow_imp.dz('20260715113056Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8143065617387830)
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260714070825Z')
,p_updated_on=>wwv_flow_imp.dz('20260714081147Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8141818434387823)
,p_db_column_name=>'APPOINTMENT_ID'
,p_display_order=>20
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
,p_column_label=>'Appointment ID'
,p_column_link=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.::P14_APPOINTMENT_ID:#APPOINTMENT_ID#'
,p_column_linktext=>'#APPOINTMENT_ID#'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'LEFT'
,p_use_as_row_header=>'N'
,p_created_on=>wwv_flow_imp.dz('20260714070825Z')
,p_updated_on=>wwv_flow_imp.dz('20260715112728Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8143498238387831)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8091739987179527)
,p_db_column_name=>'CREATED_AT'
,p_display_order=>110
...
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260714081645Z')
,p_updated_on=>wwv_flow_imp.dz('20260714081645Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8091213762179522)
...
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260714081607Z')
,p_updated_on=>wwv_flow_imp.dz('20260714081645Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8091136236179521)
...
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260714081127Z')
,p_updated_on=>wwv_flow_imp.dz('20260715113056Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8144250144387835)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8091573535179525)
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260714081607Z')
,p_updated_on=>wwv_flow_imp.dz('20260714081725Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8147321268392287)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'primary'
,p_status=>'PUBLIC'
...
,p_created_on=>wwv_flow_imp.dz('20260714070909Z')
,p_updated_on=>wwv_flow_imp.dz('20260714081607Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8146784987387842)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8145019972387838)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8140699823387810)
,p_button_name=>'CREATE'
,p_static_id=>'create'
,p_show_as_disabled=>false
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8145427642387838)
,p_name=>'Edit Report - Dialog Closed'
,p_static_id=>'edit-report-dialog-closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8140699823387810)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
,p_created_on=>wwv_flow_imp.dz('20260714070825Z')
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8145896771387841)
,p_event_id=>wwv_flow_imp.id(8145427642387838)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-refresh'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8140699823387810)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260714070825Z')
,p_updated_on=>wwv_flow_imp.dz('20260714070825Z')
...
,p_page_component_map=>'02'
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260714080104Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8129280665387528)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8136149171387550)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2127905476394690047
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8090470549179514)
,p_plug_name=>'Doctor Details'
,p_static_id=>'doctor-details'
,p_parent_plug_id=>wwv_flow_imp.id(8129280665387528)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
,p_location=>null
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p><strong>Department:</strong> <span id="doc-dept">-</span></p>',
'   <p><strong>Specialty:</strong> <span id="doc-spec">-</span></p>'))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260714075937Z')
,p_updated_on=>wwv_flow_imp.dz('20260714075937Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8136557169387550)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8136149171387550)
,p_button_name=>'CANCEL'
,p_static_id=>'cancel'
,p_show_as_disabled=>false
,p_button_action=>'DEFINED_BY_DA_ACTION'
...
wwv_flow_imp_page.create_component_da_action(
 p_id=>wwv_flow_imp.id(8137053540387551)
,p_button_id=>wwv_flow_imp.id(8136557169387550)
,p_action_sequence=>10
,p_action=>'NATIVE_DIALOG_CANCEL'
,p_static_id=>'native-dialog-cancel'
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8138328950387553)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(8136149171387550)
,p_button_name=>'CREATE'
,p_static_id=>'create'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8137567009387552)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8136149171387550)
,p_button_name=>'DELETE'
,p_static_id=>'delete'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8137929837387553)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(8136149171387550)
,p_button_name=>'SAVE'
,p_static_id=>'save'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8131498382387546)
,p_name=>'P11_APPOINTMENT_DATE'
,p_source_data_type=>'DATE'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8129280665387528)
,p_item_source_plug_id=>wwv_flow_imp.id(8129280665387528)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8129620408387529)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8131864784387546)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8130721190387545)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_updated_on=>wwv_flow_imp.dz('20260714071823Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8130066625387535)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_updated_on=>wwv_flow_imp.dz('20260714071710Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8132963298387547)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8132254360387547)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8089987220179509)
,p_validation_name=>'Prevent Past Appointment Date'
,p_static_id=>'prevent-past-appointment-date'
,p_validation_sequence=>10
,p_validation=>'TRUNC(TO_DATE(:P11_APPOINTMENT_DATE, ''MM/DD/YYYY'')) >= TRUNC(SYSDATE)'
,p_validation2=>'SQL'
,p_validation_type=>'EXPRESSION'
,p_error_message=>'Appointment date cannot be in the past.'
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_imp.id(8131498382387546)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
,p_created_on=>wwv_flow_imp.dz('20260714072307Z')
,p_updated_on=>wwv_flow_imp.dz('20260714073753Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8090204207179512)
...
,p_created_on=>wwv_flow_imp.dz('20260714074253Z')
,p_updated_on=>wwv_flow_imp.dz('20260714080104Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8090399931179513)
,p_event_id=>wwv_flow_imp.id(8090204207179512)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    ...
    '                 $("#doc-dept").text(pData.department);',
    '                 $("#doc-spec").text(pData.specialty);',
    '             }',
    '         }',
    '     );')))).to_clob
,p_created_on=>wwv_flow_imp.dz('20260714074253Z')
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8139561111387555)
...
,p_process_when=>'CREATE,SAVE,DELETE'
,p_process_when_type=>'REQUEST_IN_CONDITION'
,p_internal_uid=>8139561111387555
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_updated_on=>wwv_flow_imp.dz('20260714075937Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8090522596179515)
,p_process_sequence=>20
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Get Doctor Details'
,p_static_id=>'get-doctor-details'
...
'       JOIN DEPARTMENTS d ON doc.DEPARTMENT_ID = d.DEPARTMENT_ID',
'       JOIN DOCTOR_SPECIALTIES s ON doc.SPECIALTY_ID = s.SPECIALTY_ID',
'       WHERE doc.DOCTOR_ID = APEX_APPLICATION.G_X01;',
'',
'       apex_json.open_object;',
'       apex_json.write(''department'', l_dept);',
'       apex_json.write(''specialty'', l_spec);',
'       apex_json.close_object;',
'   EXCEPTION',
'       WHEN NO_DATA_FOUND THEN',
'           apex_json.open_object;',
'           apex_json.write(''department'', ''-'');',
'           apex_json.write(''specialty'', ''-'');',
'           apex_json.close_object;',
'   END;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>8090522596179515
,p_created_on=>wwv_flow_imp.dz('20260714075937Z')
,p_updated_on=>wwv_flow_imp.dz('20260714075937Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8138723256387553)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(8129280665387528)
,p_process_type=>'NATIVE_FORM_INIT'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'next_primary_key_items', '',
  'previous_primary_key_items', '')).to_clob
,p_internal_uid=>8138723256387553
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_updated_on=>wwv_flow_imp.dz('20260714070822Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8139123185387554)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(8129280665387528)
,p_process_type=>'NATIVE_FORM_DML'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'target_type', 'REGION_SOURCE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8139123185387554
,p_created_on=>wwv_flow_imp.dz('20260714070822Z')
,p_updated_on=>wwv_flow_imp.dz('20260714070822Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
,p_created_on=>wwv_flow_imp.dz('20260714113318Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715080714Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16728576040889249)
...
,p_master_region_id=>wwv_flow_imp.id(16744212616928303)
,p_prn_units=>'INCHES'
,p_prn_paper_size=>'LETTER'
,p_prn_width=>11
,p_prn_height=>8.5
...
,p_prn_page_footer_alignment=>'CENTER'
,p_prn_border_color=>'#666666'
,p_created_on=>wwv_flow_imp.dz('20260714113319Z')
,p_updated_on=>wwv_flow_imp.dz('20260715080714Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16772521673933715)
...
,p_updated_on=>wwv_flow_imp.dz('20260714113319Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16772407169933713)
,p_name=>'ADMISSION_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16772722944933717)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16772678490933716)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16771603146933705)
,p_name=>'DOCTOR_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16771436634933704)
,p_name=>'PATIENT_ID'
,p_source_type=>'DB_COLUMN'
...
,p_use_as_row_header=>false
,p_is_primary_key=>false
,p_parent_column_id=>wwv_flow_imp.id(16747000084928550)
,p_include_in_export=>false
,p_updated_on=>wwv_flow_imp.dz('20260714113319Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16772482826933714)
,p_name=>'ROOM_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16772888449933718)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(16728703706889250)
,p_internal_uid=>16728703706889250
,p_is_editable=>false
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(16778514548935608)
,p_interactive_grid_id=>wwv_flow_imp.id(16728703706889250)
,p_static_id=>'primary'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
,p_settings_area_expanded=>true
,p_updated_on=>wwv_flow_imp.dz('20260714112827Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(16778663136935608)
,p_report_id=>wwv_flow_imp.id(16778514548935608)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16789890143935633)
,p_view_id=>wwv_flow_imp.id(16778663136935608)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(16771436634933704)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16790786630935635)
,p_view_id=>wwv_flow_imp.id(16778663136935608)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(16771603146933705)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16791650519935637)
,p_view_id=>wwv_flow_imp.id(16778663136935608)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(16772407169933713)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16792542864935639)
,p_view_id=>wwv_flow_imp.id(16778663136935608)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(16772482826933714)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16793472402935641)
,p_view_id=>wwv_flow_imp.id(16778663136935608)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(16772521673933715)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16794324575935643)
,p_view_id=>wwv_flow_imp.id(16778663136935608)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(16772678490933716)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16795226384935645)
,p_view_id=>wwv_flow_imp.id(16778663136935608)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(16772722944933717)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16796188579935647)
,p_view_id=>wwv_flow_imp.id(16778663136935608)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(16772888449933718)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16773266310933722)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16759403550928685)
,p_plug_name=>'Appointments'
,p_static_id=>'appointments'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--hideHeader js-addHiddenHeadingRoleDesc'
,p_plug_template=>2102002977963900996
...
,p_prn_border_color=>'#666666'
,p_created_on=>wwv_flow_imp.dz('20260714113319Z')
,p_updated_on=>wwv_flow_imp.dz('20260715080541Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16765156071928700)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16762146997928693)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16766117633928703)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16769194709928710)
,p_name=>'CREATED_AT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16764212001928698)
,p_name=>'DOCTOR_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DOCTOR_ID'
,p_data_type=>'VARCHAR2'
...
,p_duplicate_value=>true
,p_include_in_export=>true
,p_updated_on=>wwv_flow_imp.dz('20260715080354Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16763196369928695)
,p_name=>'PATIENT_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'PATIENT_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16768125143928708)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16767158094928705)
,p_name=>'STATUS_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(16759451460928685)
,p_internal_uid=>16759451460928685
,p_is_editable=>false
,p_lazy_loading=>false
,p_requires_filter=>false
,p_select_first_row=>true
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(16760191109928688)
,p_interactive_grid_id=>wwv_flow_imp.id(16759451460928685)
,p_static_id=>'primary'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(16760267692928688)
,p_report_id=>wwv_flow_imp.id(16760191109928688)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16762683427928695)
,p_view_id=>wwv_flow_imp.id(16760267692928688)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(16762146997928693)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16763683414928697)
,p_view_id=>wwv_flow_imp.id(16760267692928688)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(16763196369928695)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16764686975928700)
,p_view_id=>wwv_flow_imp.id(16760267692928688)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(16764212001928698)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16765695673928702)
,p_view_id=>wwv_flow_imp.id(16760267692928688)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(16765156071928700)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16766686760928705)
,p_view_id=>wwv_flow_imp.id(16760267692928688)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(16766117633928703)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16767634359928707)
,p_view_id=>wwv_flow_imp.id(16760267692928688)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(16767158094928705)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16768677900928710)
,p_view_id=>wwv_flow_imp.id(16760267692928688)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(16768125143928708)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16769638127928712)
,p_view_id=>wwv_flow_imp.id(16760267692928688)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(16769194709928710)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16773036821933720)
,p_plug_name=>'Appointments'
,p_static_id=>'appointments_1'
,p_title=>'Appointments'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--noIcon:t-Alert--warning'
,p_plug_template=>2042159785845301134
,p_plug_display_sequence=>50
,p_plug_item_display_point=>'ABOVE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16744212616928303)
...
,p_prn_border_color=>'#666666'
,p_created_on=>wwv_flow_imp.dz('20260714113318Z')
,p_updated_on=>wwv_flow_imp.dz('20260714113318Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16755000990928569)
,p_name=>'ADDRESS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16753986930928567)
,p_name=>'BLOOD_GROUP'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16747938859928553)
,p_name=>'CIVIL_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16757952681928576)
,p_name=>'CREATED_AT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'CREATED_AT'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16750914226928560)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16752961943928565)
,p_name=>'EMAIL'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16755975834928571)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16756943178928573)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16748944650928556)
,p_name=>'FULL_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16750007351928558)
,p_name=>'GENDER'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16751947358928563)
,p_name=>'MOBILE_NO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16747000084928550)
,p_name=>'PATIENT_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'PATIENT_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(16744276236928542)
,p_internal_uid=>16744276236928542
,p_is_editable=>false
,p_lazy_loading=>false
,p_requires_filter=>false
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(16744945936928546)
,p_interactive_grid_id=>wwv_flow_imp.id(16744276236928542)
,p_static_id=>'primary'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(16745046199928546)
,p_report_id=>wwv_flow_imp.id(16744945936928546)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16747416238928552)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(16747000084928550)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16748459870928555)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(16747938859928553)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16749453222928558)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(16748944650928556)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16750488412928560)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(16750007351928558)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16751451184928562)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(16750914226928560)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16752485533928565)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(16751947358928563)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16753493522928567)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(16752961943928565)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16754443272928569)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(16753986930928567)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16755451416928571)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(16755000990928569)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16756494333928573)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>10
,p_column_id=>wwv_flow_imp.id(16755975834928571)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16757502957928575)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>11
,p_column_id=>wwv_flow_imp.id(16756943178928573)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16758420854928578)
,p_view_id=>wwv_flow_imp.id(16745046199928546)
,p_display_seq=>12
,p_column_id=>wwv_flow_imp.id(16757952681928576)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16772975293933719)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16726691777889230)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16727022853889234)
,p_name=>'APPOINTMENT_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'APPOINTMENT_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16728250480889246)
,p_name=>'DIAGNOSIS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16727290728889236)
,p_name=>'DOCTOR_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DOCTOR_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16728464776889248)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16728404255889247)
,p_name=>'NOTES'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16727135660889235)
,p_name=>'PATIENT_ID'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'PATIENT_ID'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16728138689889245)
,p_name=>'SYMPTOMS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16728071261889244)
,p_name=>'VISIT_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(16727935642889243)
,p_name=>'VISIT_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(16726787126889231)
,p_internal_uid=>16726787126889231
,p_is_editable=>false
,p_lazy_loading=>false
,p_requires_filter=>false
,p_select_first_row=>true
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(16778001326935605)
,p_interactive_grid_id=>wwv_flow_imp.id(16726787126889231)
,p_static_id=>'primary'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(16778071682935606)
,p_report_id=>wwv_flow_imp.id(16778001326935605)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16780425072935613)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(16727022853889234)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16781322120935615)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(16727135660889235)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16782279188935617)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(16727290728889236)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16783208188935619)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(16727935642889243)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16784080825935621)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(16728071261889244)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16784996673935622)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(16728138689889245)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16785908382935624)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(16728250480889246)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16786757280935626)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(16728404255889247)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(16787636523935628)
,p_view_id=>wwv_flow_imp.id(16778071682935606)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(16728464776889248)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16773130522933721)
,p_plug_name=>'Visit History'
,p_static_id=>'visit-history_1'
,p_title=>'Visit History'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--noIcon:t-Alert--warning'
,p_plug_template=>2042159785845301134
...
wwv_flow_imp_page.create_page(
 p_id=>13
,p_name=>'Visit & Prescription Management'
,p_alias=>'VISIT-PRESCRIPTION-MANAGEMENT'
,p_step_title=>'Visit & Prescription Management'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>4073832297226169690
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'21'
,p_created_on=>wwv_flow_imp.dz('20260715045821Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715075300Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8644241545063210)
,p_plug_name=>'Add Prescription Item'
,p_static_id=>'add-prescription-item'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
,p_plug_display_sequence=>50
,p_plug_item_display_point=>'ABOVE'
...
,p_plug_display_when_condition=>'P13_PRESCRIPTION_ID'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715072210Z')
,p_updated_on=>wwv_flow_imp.dz('20260715072210Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8465344076289431)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8592277351623341)
...
,p_location=>null
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P13_VISIT_ID'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715062859Z')
,p_updated_on=>wwv_flow_imp.dz('20260715062859Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8645502265063223)
,p_plug_name=>'Prescription History'
,p_static_id=>'prescription-history'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--noIcon:t-Alert--warning'
,p_plug_template=>2042159785845301134
,p_plug_display_sequence=>60
,p_plug_item_display_point=>'ABOVE'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715073105Z')
,p_updated_on=>wwv_flow_imp.dz('20260715073105Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8593035402623349)
...
,p_query_where=>'PRESCRIPTION_ID = :P13_PRESCRIPTION_ID'
,p_include_rowid_column=>false
,p_plug_source_type=>'NATIVE_IG'
,p_prn_units=>'INCHES'
,p_prn_paper_size=>'LETTER'
...
,p_prn_page_footer_alignment=>'CENTER'
,p_prn_border_color=>'#666666'
,p_created_on=>wwv_flow_imp.dz('20260715071056Z')
,p_updated_on=>wwv_flow_imp.dz('20260715073105Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8643632926063204)
,p_name=>'DOSAGE'
,p_source_type=>'DB_COLUMN'
...
,p_duplicate_value=>true
,p_include_in_export=>true
,p_updated_on=>wwv_flow_imp.dz('20260715071056Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8643867078063206)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8643737719063205)
,p_name=>'FREQUENCY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8643976988063207)
,p_name=>'INSTRUCTIONS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8643532038063203)
,p_name=>'MEDICINE_ID'
,p_source_type=>'DB_COLUMN'
...
,p_lov_type=>'SQL_QUERY'
,p_lov_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT MEDICINE_NAME AS DISPLAY_VALUE, MEDICINE_ID AS RETURN_VALUE',
'FROM MEDICINES',
'WHERE STATUS = ''Active''',
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8643463129063202)
...
,p_is_primary_key=>false
,p_default_type=>'ITEM'
,p_default_expression=>'P13_PRESCRIPTION_ID'
,p_duplicate_value=>true
,p_include_in_export=>false
,p_updated_on=>wwv_flow_imp.dz('20260715071056Z')
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(8643322331063201)
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(8593114414623350)
,p_internal_uid=>8593114414623350
,p_is_editable=>false
,p_lazy_loading=>false
,p_requires_filter=>false
,p_select_first_row=>true
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(8649636720085007)
,p_interactive_grid_id=>wwv_flow_imp.id(8593114414623350)
,p_static_id=>'primary'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_show_row_number=>false
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(8649758565085009)
,p_report_id=>wwv_flow_imp.id(8649636720085007)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(8650215131085013)
,p_view_id=>wwv_flow_imp.id(8649758565085009)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(8643322331063201)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(8651122490085015)
,p_view_id=>wwv_flow_imp.id(8649758565085009)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(8643463129063202)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(8652068116085017)
,p_view_id=>wwv_flow_imp.id(8649758565085009)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(8643532038063203)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(8652922129085019)
,p_view_id=>wwv_flow_imp.id(8649758565085009)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(8643632926063204)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(8653872399085021)
,p_view_id=>wwv_flow_imp.id(8649758565085009)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(8643737719063205)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(8654713842085023)
,p_view_id=>wwv_flow_imp.id(8649758565085009)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(8643867078063206)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(8655638380085025)
,p_view_id=>wwv_flow_imp.id(8649758565085009)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(8643976988063207)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8443670346712503)
,p_plug_name=>'Select Doctor and Visit'
,p_static_id=>'select-doctor-and-visit'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
,p_plug_display_sequence=>10
,p_plug_item_display_point=>'ABOVE'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715051431Z')
,p_updated_on=>wwv_flow_imp.dz('20260715051431Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8591477158623333)
,p_name=>'Visit Details'
...
'       TO_CHAR(v.VISIT_DATE,''DD-MON-YYYY'') AS VISIT_DATE,',
'       v.SYMPTOMS, v.DIAGNOSIS, v.NOTES',
'FROM PATIENT_VISITS v',
'JOIN PATIENTS p ON v.PATIENT_ID = p.PATIENT_ID',
'WHERE v.VISIT_ID = :P13_VISIT_ID'))
,p_display_when_condition=>'P13_VISIT_ID'
,p_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P13_VISIT_ID'
,p_lazy_loading=>false
...
,p_created_on=>wwv_flow_imp.dz('20260715060251Z')
,p_updated_on=>wwv_flow_imp.dz('20260715061724Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8591979143623338)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8592008484623339)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8591523078623334)
,p_query_column_id=>1
...
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_updated_on=>wwv_flow_imp.dz('20260715060251Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8591840567623337)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8591725911623336)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8644960012063217)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_imp.id(8644241545063210)
,p_button_name=>'ADD_PRESCRIPTION_ITEM'
,p_static_id=>'add-prescription-item'
,p_show_as_disabled=>false
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715072210Z')
,p_updated_on=>wwv_flow_imp.dz('20260715075006Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8592308337623342)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(8592277351623341)
...
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715062859Z')
,p_updated_on=>wwv_flow_imp.dz('20260715070016Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8445860641712525)
,p_branch_name=>'Branch to Same Page'
,p_branch_action=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8592308337623342)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8645271659063220)
,p_branch_name=>'Branch to Same Page'
,p_branch_action=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8644960012063217)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8443774355712504)
,p_name=>'P13_DOCTOR_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8443670346712503)
,p_prompt=>'Doctor'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715051431Z')
,p_updated_on=>wwv_flow_imp.dz('20260715052135Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8644424391063212)
,p_name=>'P13_ITEM_DOSAGE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8644241545063210)
,p_prompt=>'Dosage'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8644732578063215)
,p_name=>'P13_ITEM_DURATION_DAYS'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8644241545063210)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8644655535063214)
,p_name=>'P13_ITEM_FREQUENCY'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8644241545063210)
,p_prompt=>'Frequency'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8644828535063216)
,p_name=>'P13_ITEM_INSTRUCTIONS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(8644241545063210)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8644311521063211)
,p_name=>'P13_ITEM_MEDICINE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8644241545063210)
,p_prompt=>'Medicine '
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8592542615623344)
,p_name=>'P13_PRESCRIPTION_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8592277351623341)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8592436948623343)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715062859Z')
,p_updated_on=>wwv_flow_imp.dz('20260715072329Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8592685955623345)
,p_name=>'P13_PRESCRIPTION_NOTES'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8592277351623341)
,p_prompt=>'Notes'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8443858832712505)
,p_name=>'P13_VISIT_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8443670346712503)
,p_prompt=>'Visit Id'
...
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT p.FULL_NAME || '' - '' || TO_CHAR(v.VISIT_DATE, ''DD-MON-YYYY'') AS DISPLAY_VALUE,',
'            v.VISIT_ID AS RETURN_VALUE',
'     FROM PATIENT_VISITS v',
'     JOIN PATIENTS p ON v.PATIENT_ID = p.PATIENT_ID',
'     WHERE v.DOCTOR_ID = :P13_DOCTOR_ID',
'     ORDER BY v.VISIT_DATE DESC'))
,p_lov_display_null=>'YES'
,p_lov_cascade_parent_items=>'P13_DOCTOR_ID'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715051431Z')
,p_updated_on=>wwv_flow_imp.dz('20260715061805Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8592798930623346)
...
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
,p_created_on=>wwv_flow_imp.dz('20260715064015Z')
,p_updated_on=>wwv_flow_imp.dz('20260715064015Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8592821192623347)
,p_event_id=>wwv_flow_imp.id(8592798930623346)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-execute-plsql-code'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_return', 'P13_PRESCRIPTION_ID,P13_PRESCRIPTION_DATE,P13_PRESCRIPTION_NOTES',
  'items_to_submit', 'P13_VISIT_ID',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'BEGIN',
    '    SELECT PRESCRIPTION_ID, PRESCRIPTION_DATE, NOTES',
    '    INTO :P13_PRESCRIPTION_ID, :P13_PRESCRIPTION_DATE, :P13_PRESCRIPTION_NOTES',
    '    FROM PRESCRIPTIONS',
    '    WHERE VISIT_ID = :P13_VISIT_ID;',
    'EXCEPTION',
    '    WHEN NO_DATA_FOUND THEN',
    '        :P13_PRESCRIPTION_ID := NULL;',
    '        :P13_PRESCRIPTION_DATE := NULL;',
    '        :P13_PRESCRIPTION_NOTES := NULL;',
    'END;')),
  'show_processing', 'N',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8592911813623348)
,p_event_id=>wwv_flow_imp.id(8592798930623346)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8592277351623341)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715064015Z')
,p_updated_on=>wwv_flow_imp.dz('20260715064015Z')
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8644058354063208)
,p_name=>'Load Prescription Items'
,p_static_id=>'load-prescription-items'
,p_event_sequence=>50
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P13_VISIT_ID'
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8644127307063209)
,p_event_id=>wwv_flow_imp.id(8644058354063208)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-refresh'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8593035402623349)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715071056Z')
,p_updated_on=>wwv_flow_imp.dz('20260715071056Z')
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8447096231712537)
,p_name=>'Load Visit'
,p_static_id=>'load-visit-and-prescription'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P13_VISIT_ID'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
,p_created_on=>wwv_flow_imp.dz('20260715053435Z')
,p_updated_on=>wwv_flow_imp.dz('20260715064015Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8447175845712538)
,p_event_id=>wwv_flow_imp.id(8447096231712537)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-execute-plsql-code'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P13_VISIT_ID',
  'language', 'PLSQL',
  'plsql_code', 'NULL; -- no-op, we just need this action to submit the item and trigger a refresh',
  'show_processing', 'N')).to_clob
,p_wait_for_result=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715053435Z')
,p_updated_on=>wwv_flow_imp.dz('20260715061422Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8592101465623340)
,p_event_id=>wwv_flow_imp.id(8447096231712537)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8591477158623333)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715061421Z')
,p_updated_on=>wwv_flow_imp.dz('20260715061421Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8446849459712535)
,p_name=>'CLEAR IRRELEVANT VISITS'
,p_static_id=>'new_1'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P13_DOCTOR_ID'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
,p_created_on=>wwv_flow_imp.dz('20260715052135Z')
,p_updated_on=>wwv_flow_imp.dz('20260715053435Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8446931851712536)
,p_event_id=>wwv_flow_imp.id(8446849459712535)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'CLEAR'
,p_static_id=>'clear-irrelevant-visits'
,p_action=>'NATIVE_CLEAR'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P13_VISIT_ID'
,p_created_on=>wwv_flow_imp.dz('20260715052135Z')
,p_updated_on=>wwv_flow_imp.dz('20260715053435Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8645398622063221)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Clear Item Form'
,p_static_id=>'clear-item-form'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items', 'P13_ITEM_MEDICINE_ID,P13_ITEM_DOSAGE,P13_ITEM_FREQUENCY,P13_ITEM_DURATION_DAYS,P13_ITEM_INSTRUCTIONS',
  'type', 'CLEAR_CACHE_FOR_ITEMS')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8644960012063217)
,p_internal_uid=>8645398622063221
,p_created_on=>wwv_flow_imp.dz('20260715072210Z')
,p_updated_on=>wwv_flow_imp.dz('20260715072210Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8445750178712524)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    l_patient_id PATIENT_VISITS.PATIENT_ID%TYPE;',
'    l_doctor_id  PATIENT_VISITS.DOCTOR_ID%TYPE;',
'BEGIN',
'    SELECT PATIENT_ID, DOCTOR_ID INTO l_patient_id, l_doctor_id',
'    FROM PATIENT_VISITS WHERE VISIT_ID = :P13_VISIT_ID;',
'',
'    INSERT INTO PRESCRIPTIONS (VISIT_ID, PATIENT_ID, DOCTOR_ID, PRESCRIPTION_DATE, NOTES)',
'    VALUES (:P13_VISIT_ID, l_patient_id, l_doctor_id,',
'            NVL(:P13_PRESCRIPTION_DATE, SYSDATE), :P13_PRESCRIPTION_NOTES)',
'    RETURNING PRESCRIPTION_ID INTO :P13_PRESCRIPTION_ID;',
'EXCEPTION',
'    WHEN DUP_VAL_ON_INDEX THEN',
'        RAISE_APPLICATION_ERROR(-20001, ''Only one prescription per visit.'');',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8592308337623342)
,p_process_success_message=>'Prescription created successfully.'
,p_internal_uid=>8445750178712524
,p_created_on=>wwv_flow_imp.dz('20260715051431Z')
,p_updated_on=>wwv_flow_imp.dz('20260715070253Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8645084513063218)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Insert Prescription Item'
,p_static_id=>'insert-prescription-item'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'    INSERT INTO PRESCRIPTION_ITEMS (',
'        PRESCRIPTION_ID, MEDICINE_ID, DOSAGE, FREQUENCY, DURATION_DAYS, INSTRUCTIONS',
'    ) VALUES (',
'        :P13_PRESCRIPTION_ID, :P13_ITEM_MEDICINE_ID, :P13_ITEM_DOSAGE,',
'        :P13_ITEM_FREQUENCY, :P13_ITEM_DURATION_DAYS, :P13_ITEM_INSTRUCTIONS',
'    );',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8644960012063217)
,p_process_success_message=>'Medicine added to prescription.'
,p_internal_uid=>8645084513063218
,p_created_on=>wwv_flow_imp.dz('20260715072210Z')
,p_updated_on=>wwv_flow_imp.dz('20260715072210Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
,p_created_on=>wwv_flow_imp.dz('20260715081313Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715113151Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17331617941929095)
,p_plug_name=>'Add Prescription Item'
,p_static_id=>'add-prescription-item'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
,p_location=>null
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P14_PRESCRIPTION_ID'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715100858Z')
,p_updated_on=>wwv_flow_imp.dz('20260715111728Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8646652483063234)
...
,p_query_type=>'SQL'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT TO_CHAR(a.APPOINTMENT_DATE, ''DD-MON-YYYY'') AS APPOINTMENT_DATE,',
'       a.APPOINTMENT_TIME,',
'       aps.STATUS_NAME AS APPOINTMENT_STATUS,',
'       a.REASON_FOR_VISIT',
'FROM APPOINTMENTS a',
'JOIN APPOINTMENT_STATUSES aps ON a.STATUS_ID = aps.STATUS_ID',
'WHERE a.APPOINTMENT_ID = :P14_APPOINTMENT_ID'))
,p_display_when_condition=>'P14_APPOINTMENT_ID'
,p_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>2540130677583398057
...
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715082100Z')
,p_updated_on=>wwv_flow_imp.dz('20260715082957Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646787911063235)
,p_query_column_id=>1
...
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_updated_on=>wwv_flow_imp.dz('20260715082100Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646994641063237)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646856435063236)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8647038716063238)
,p_query_column_id=>4
...
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_updated_on=>wwv_flow_imp.dz('20260715082101Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8668570985458763)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8647167247063239)
...
,p_query_type=>'SQL'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT doc.FULL_NAME AS DOCTOR_NAME,',
'       dept.DEPARTMENT_NAME,',
'       spec.SPECIALTY_NAME',
'FROM APPOINTMENTS a',
'JOIN DOCTORS doc ON a.DOCTOR_ID = doc.DOCTOR_ID',
'JOIN DEPARTMENTS dept ON doc.DEPARTMENT_ID = dept.DEPARTMENT_ID',
'JOIN DOCTOR_SPECIALTIES spec ON doc.SPECIALTY_ID = spec.SPECIALTY_ID',
'WHERE a.APPOINTMENT_ID = :P14_APPOINTMENT_ID'))
,p_display_when_condition=>'P14_APPOINTMENT_ID'
,p_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_ajax_enabled=>'Y'
...
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715082957Z')
,p_updated_on=>wwv_flow_imp.dz('20260715082957Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8647330838063241)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8647291577063240)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8647402782063242)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8645913190063227)
...
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715081816Z')
,p_updated_on=>wwv_flow_imp.dz('20260715081816Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646236525063230)
,p_query_column_id=>3
,p_column_alias=>'AGE'
,p_column_display_sequence=>30
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646419451063232)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646120848063229)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646088459063228)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646356160063231)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8646593700063233)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8676380446626606)
,p_plug_name=>'Prescription'
,p_static_id=>'prescription'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
,p_location=>null
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P14_VISIT_ID'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715100757Z')
,p_updated_on=>wwv_flow_imp.dz('20260715111729Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8677487458626617)
,p_name=>'Prescription Items List'
,p_static_id=>'prescription-items-list'
,p_template=>4073835273271169698
,p_display_sequence=>90
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
...
'WHERE pi.PRESCRIPTION_ID = :P14_PRESCRIPTION_ID',
'ORDER BY pi.PRESCRIPTION_ITEM_ID'))
,p_display_when_condition=>'P14_PRESCRIPTION_ID'
,p_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>2540130677583398057
...
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715102546Z')
,p_updated_on=>wwv_flow_imp.dz('20260715111729Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8677646416626619)
,p_query_column_id=>2
...
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_updated_on=>wwv_flow_imp.dz('20260715102547Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8677814940626621)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8677797726626620)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8677967164626622)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8677575782626618)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8678172857626624)
,p_name=>'Previous Visit'
,p_static_id=>'previous-visit'
,p_template=>4073835273271169698
,p_display_sequence=>50
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
...
'WHERE v.PATIENT_ID = (',
'    SELECT PATIENT_ID FROM PATIENT_VISITS WHERE VISIT_ID = :P14_VISIT_ID',
')',
'AND v.VISIT_ID != :P14_VISIT_ID',
'ORDER BY v.VISIT_DATE DESC'))
,p_display_when_condition=>'P14_VISIT_ID'
,p_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>2540130677583398057
...
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715111157Z')
,p_updated_on=>wwv_flow_imp.dz('20260715111729Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8678637692626629)
,p_query_column_id=>5
,p_column_alias=>'DIAGNOSIS'
,p_column_display_sequence=>50
,p_column_heading=>'Diagnosis'
...
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_updated_on=>wwv_flow_imp.dz('20260715111158Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8678443415626627)
,p_query_column_id=>3
,p_column_alias=>'DOCTOR_NAME'
,p_column_display_sequence=>30
,p_column_heading=>'Doctor Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8678701936626630)
,p_query_column_id=>6
,p_column_alias=>'NOTES'
,p_column_display_sequence=>60
,p_column_heading=>'Notes'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8678578563626628)
,p_query_column_id=>4
,p_column_alias=>'SYMPTOMS'
,p_column_display_sequence=>40
,p_column_heading=>'Symptoms'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8678380857626626)
,p_query_column_id=>2
,p_column_alias=>'VISIT_DATE'
,p_column_display_sequence=>20
,p_column_heading=>'Visit Date'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8678207672626625)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8647521619063243)
...
,p_location=>null
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P14_APPOINTMENT_ID'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715084358Z')
,p_updated_on=>wwv_flow_imp.dz('20260715111728Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8687771955865911)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_imp.id(17331617941929095)
,p_button_name=>'ADD_PRESCRIPTION_ITEM'
,p_static_id=>'add-prescription-item'
,p_show_as_disabled=>false
,p_button_action=>'SUBMIT'
...
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715100858Z')
,p_updated_on=>wwv_flow_imp.dz('20260715100858Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8676867154626611)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(8676380446626606)
,p_button_name=>'CREATE_PRESCRIPTION'
,p_static_id=>'create-prescription'
,p_show_as_disabled=>false
,p_button_action=>'SUBMIT'
...
,p_button_condition_type=>'ITEM_IS_NULL'
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715100758Z')
,p_updated_on=>wwv_flow_imp.dz('20260715100758Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8676083294626603)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(8647521619063243)
...
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715084358Z')
,p_updated_on=>wwv_flow_imp.dz('20260715084358Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8676242845626605)
,p_branch_action=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8676083294626603)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8677224271626615)
,p_branch_action=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8687771955865911)
,p_branch_sequence=>30
,p_created_on=>wwv_flow_imp.dz('20260715102547Z')
,p_updated_on=>wwv_flow_imp.dz('20260715105136Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8678036735626623)
,p_branch_action=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8676867154626611)
,p_branch_sequence=>20
,p_created_on=>wwv_flow_imp.dz('20260715105136Z')
,p_updated_on=>wwv_flow_imp.dz('20260715105136Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8645738675063225)
,p_name=>'P14_APPOINTMENT_ID'
,p_item_sequence=>10
,p_prompt=>'Appointment Number'
,p_source_type=>'ALWAYS_NULL'
...
,p_created_on=>wwv_flow_imp.dz('20260715081816Z')
,p_updated_on=>wwv_flow_imp.dz('20260715113151Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8647829621063246)
,p_name=>'P14_DIAGNOSIS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8647521619063243)
,p_prompt=>'Diagnosis'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8648057505063248)
,p_name=>'P14_FOLLOW_UP_DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8647521619063243)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17332579996929126)
,p_name=>'P14_ITEM_DOSAGE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17331617941929095)
,p_prompt=>'Dosage'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17332888183929129)
,p_name=>'P14_ITEM_DURATION_DAYS'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(17331617941929095)
,p_prompt=>'Duration (Days)'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17332811140929128)
,p_name=>'P14_ITEM_FREQUENCY'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(17331617941929095)
,p_prompt=>'Frequency'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17332984140929130)
,p_name=>'P14_ITEM_INSTRUCTIONS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(17331617941929095)
,p_prompt=>'Instructions'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17332467126929125)
,p_name=>'P14_ITEM_MEDICINE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(17331617941929095)
,p_prompt=>'Medicine '
,p_source_type=>'ALWAYS_NULL'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'page_action_on_selection', 'NONE')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715100858Z')
,p_updated_on=>wwv_flow_imp.dz('20260715105856Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8647955304063247)
,p_name=>'P14_NOTES'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8647521619063243)
,p_prompt=>'Notes'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8676470190626607)
,p_name=>'P14_PRESCRIPTION_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8676380446626606)
,p_prompt=>'Prescription Date'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_DATE_PICKER_APEX'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8676699580626609)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715100758Z')
,p_updated_on=>wwv_flow_imp.dz('20260715100946Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8676527639626608)
,p_name=>'P14_PRESCRIPTION_NOTES'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8676380446626606)
,p_prompt=>'Notes'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8647773728063245)
,p_name=>'P14_SYMPTOMS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8647521619063243)
,p_prompt=>'Symptoms'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8647616478063244)
,p_name=>'P14_VISIT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8647521619063243)
,p_source_type=>'ALWAYS_NULL'
...
,p_created_on=>wwv_flow_imp.dz('20260715084358Z')
,p_updated_on=>wwv_flow_imp.dz('20260715103047Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8675872563626601)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8675915568626602)
,p_event_id=>wwv_flow_imp.id(8675872563626601)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_name=>'visit-loading'
,p_static_id=>'native-execute-plsql-code'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_return', 'P14_VISIT_ID,P14_SYMPTOMS,P14_DIAGNOSIS,P14_NOTES,P14_FOLLOW_UP_DATE',
  'items_to_submit', 'P14_APPOINTMENT_ID',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'BEGIN',
    '    SELECT VISIT_ID, SYMPTOMS, DIAGNOSIS, NOTES, FOLLOW_UP_DATE',
    '    INTO :P14_VISIT_ID, :P14_SYMPTOMS, :P14_DIAGNOSIS, :P14_NOTES, :P14_FOLLOW_UP_DATE',
    '    FROM PATIENT_VISITS',
    '    WHERE APPOINTMENT_ID = :P14_APPOINTMENT_ID;',
    'EXCEPTION',
    '    WHEN NO_DATA_FOUND THEN',
    '        :P14_VISIT_ID := NULL;',
    '        :P14_SYMPTOMS := NULL;',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8676729969626610)
,p_event_id=>wwv_flow_imp.id(8675872563626601)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_name=>'Load Prescription'
,p_static_id=>'native-execute-plsql-code_1'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_return', 'P14_PRESCRIPTION_ID,P14_PRESCRIPTION_DATE,P14_PRESCRIPTION_NOTES',
  'items_to_submit', 'P14_VISIT_ID',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'BEGIN',
    '    SELECT PRESCRIPTION_ID, PRESCRIPTION_DATE, NOTES',
    '    INTO :P14_PRESCRIPTION_ID, :P14_PRESCRIPTION_DATE, :P14_PRESCRIPTION_NOTES',
    '    FROM PRESCRIPTIONS',
    '    WHERE VISIT_ID = :P14_VISIT_ID;',
    'EXCEPTION',
    '    WHEN NO_DATA_FOUND THEN',
    '        :P14_PRESCRIPTION_ID := NULL;',
    '        :P14_PRESCRIPTION_DATE := NULL;',
    '        :P14_PRESCRIPTION_NOTES := NULL;',
    'END;')),
  'show_processing', 'N',
  'suppress_change_event', 'N')).to_clob
,p_wait_for_result=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8677129653626614)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Clear Items'
,p_static_id=>'clear-items'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items', 'P14_ITEM_MEDICINE_ID,P14_ITEM_DOSAGE,P14_ITEM_FREQUENCY,P14_ITEM_DURATION_DAYS,P14_ITEM_INSTRUCTIONS',
  'type', 'CLEAR_CACHE_FOR_ITEMS')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8687771955865911)
,p_internal_uid=>8677129653626614
,p_created_on=>wwv_flow_imp.dz('20260715102546Z')
,p_updated_on=>wwv_flow_imp.dz('20260715105136Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8676902856626612)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Insert Prescription'
...
'BEGIN',
'    SELECT PATIENT_ID, DOCTOR_ID INTO l_patient_id, l_doctor_id',
'    FROM PATIENT_VISITS WHERE VISIT_ID = :P14_VISIT_ID;',
'',
'    INSERT INTO PRESCRIPTIONS (VISIT_ID, PATIENT_ID, DOCTOR_ID, PRESCRIPTION_DATE, NOTES)',
'    VALUES (:P14_VISIT_ID, l_patient_id, l_doctor_id,',
'            NVL(:P14_PRESCRIPTION_DATE, SYSDATE), :P14_PRESCRIPTION_NOTES)',
'    RETURNING PRESCRIPTION_ID INTO :P14_PRESCRIPTION_ID;',
'EXCEPTION',
'    WHEN DUP_VAL_ON_INDEX THEN',
'        RAISE_APPLICATION_ERROR(-20001, ''Only one prescription per visit.'');',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8676867154626611)
,p_process_success_message=>'Prescription created successfully.'
,p_internal_uid=>8676902856626612
,p_created_on=>wwv_flow_imp.dz('20260715100758Z')
,p_updated_on=>wwv_flow_imp.dz('20260715100758Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8677009170626613)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Insert Prescription Item'
...
'        PRESCRIPTION_ID, MEDICINE_ID, DOSAGE, FREQUENCY, DURATION_DAYS, INSTRUCTIONS',
'    ) VALUES (',
'        :P14_PRESCRIPTION_ID, :P14_ITEM_MEDICINE_ID, :P14_ITEM_DOSAGE,',
'        :P14_ITEM_FREQUENCY, :P14_ITEM_DURATION_DAYS, :P14_ITEM_INSTRUCTIONS',
'    );',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8687771955865911)
,p_process_success_message=>'Medicine added to prescription.'
,p_internal_uid=>8677009170626613
,p_created_on=>wwv_flow_imp.dz('20260715101133Z')
,p_updated_on=>wwv_flow_imp.dz('20260715105252Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8676189977626604)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'    l_doctor_id  PATIENT_VISITS.DOCTOR_ID%TYPE;',
'BEGIN',
'    IF :P14_VISIT_ID IS NULL THEN',
'        -- No visit yet for this appointment: create one',
'        SELECT PATIENT_ID, DOCTOR_ID INTO l_patient_id, l_doctor_id',
'        FROM APPOINTMENTS WHERE APPOINTMENT_ID = :P14_APPOINTMENT_ID;',
'',
'        INSERT INTO PATIENT_VISITS (',
'            APPOINTMENT_ID, PATIENT_ID, DOCTOR_ID, VISIT_DATE,',
'            SYMPTOMS, DIAGNOSIS, NOTES, FOLLOW_UP_DATE',
'        ) VALUES (',
'            :P14_APPOINTMENT_ID, l_patient_id, l_doctor_id, SYSDATE,',
'            :P14_SYMPTOMS, :P14_DIAGNOSIS, :P14_NOTES, :P14_FOLLOW_UP_DATE',
'        )',
'        RETURNING VISIT_ID INTO :P14_VISIT_ID;',
'    ELSE',
'        -- Visit already exists: update it',
'        UPDATE PATIENT_VISITS',
'        SET SYMPTOMS = :P14_SYMPTOMS,',
'            DIAGNOSIS = :P14_DIAGNOSIS,',
'            NOTES = :P14_NOTES,',
'            FOLLOW_UP_DATE = :P14_FOLLOW_UP_DATE',
'        WHERE VISIT_ID = :P14_VISIT_ID;',
'    END IF;',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8676083294626603)
,p_process_success_message=>'Visit details saved.'
,p_internal_uid=>8676189977626604
,p_created_on=>wwv_flow_imp.dz('20260715084358Z')
,p_updated_on=>wwv_flow_imp.dz('20260715084358Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page(
 p_id=>15
,p_name=>'Patient Admission Screen'
,p_alias=>'PATIENT-ADMISSION-SCREEN'
,p_step_title=>'Patient Admission Screen'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>4073832297226169690
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'03'
,p_created_on=>wwv_flow_imp.dz('20260715113533Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715122810Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8702802873385486)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8679981981626642)
...
'       doc.FULL_NAME AS DOCTOR_NAME,',
'       r.ROOM_NO,',
'       TO_CHAR(ad.ADMISSION_DATE, ''DD-MON-YYYY'') AS ADMISSION_DATE,',
'       ad.ADMISSION_REASON',
'FROM ADMISSIONS ad',
...
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715115937Z')
,p_updated_on=>wwv_flow_imp.dz('20260715121721Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8680434114626647)
,p_query_column_id=>5
...
,p_derived_column=>'N'
,p_include_in_export=>'Y'
,p_updated_on=>wwv_flow_imp.dz('20260715115937Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8680090168626643)
,p_query_column_id=>1
,p_column_alias=>'ADMISSION_ID'
,p_column_display_sequence=>10
,p_hidden_column=>'Y'
,p_derived_column=>'N'
,p_updated_on=>wwv_flow_imp.dz('20260715121707Z')
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8680564509626648)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8680254040626645)
,p_query_column_id=>3
,p_column_alias=>'DOCTOR_NAME'
,p_column_display_sequence=>30
,p_column_heading=>'Doctor Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8680100849626644)
,p_query_column_id=>2
,p_column_alias=>'PATIENT_NAME'
,p_column_display_sequence=>20
,p_column_heading=>'Patient Name'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8680371667626646)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8680656776626649)
,p_plug_name=>'Discharge Patient'
,p_static_id=>'discharge-patient'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
,p_plug_display_sequence=>40
,p_plug_item_display_point=>'ABOVE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8678893914626631)
,p_plug_name=>'New Admission'
,p_static_id=>'new-admission'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
,p_plug_display_sequence=>20
,p_plug_item_display_point=>'ABOVE'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715113705Z')
,p_updated_on=>wwv_flow_imp.dz('20260715121721Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8679498800626637)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(8678893914626631)
...
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715114924Z')
,p_updated_on=>wwv_flow_imp.dz('20260715114924Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8708827124496502)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(8680656776626649)
,p_button_name=>'DISCHARGE_PATIENT'
,p_static_id=>'discharge-patient'
,p_show_as_disabled=>false
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4073839297780169708
,p_button_image_alt=>'Discharge Patient'
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715115937Z')
,p_updated_on=>wwv_flow_imp.dz('20260715115937Z')
,p_created_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8679779311626640)
,p_branch_action=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8679498800626637)
,p_branch_sequence=>10
,p_created_on=>wwv_flow_imp.dz('20260715114924Z')
,p_updated_on=>wwv_flow_imp.dz('20260715114924Z')
,p_created_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8709042770496504)
,p_branch_action=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(8708827124496502)
,p_branch_sequence=>20
,p_created_on=>wwv_flow_imp.dz('20260715115937Z')
,p_updated_on=>wwv_flow_imp.dz('20260715115937Z')
,p_created_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8679249555626635)
,p_name=>'P15_ADMISSION_DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(8678893914626631)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'use_defaults', 'Y')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715113705Z')
,p_updated_on=>wwv_flow_imp.dz('20260715113920Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8679351483626636)
,p_name=>'P15_ADMISSION_REASON'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8678893914626631)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'resizable', 'Y',
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715113835Z')
,p_updated_on=>wwv_flow_imp.dz('20260715122810Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8680739192626650)
,p_name=>'P15_DISCHARGE_ADMISSION_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8680656776626649)
,p_prompt=>'Admitted Patient'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT p.FULL_NAME || '' - Room '' || r.ROOM_NO || '' (since '' || TO_CHAR(ad.ADMISSION_DATE,''DD-MON-YYYY'') || '')'' AS DISPLAY_VALUE,',
'       ad.ADMISSION_ID AS RETURN_VALUE',
'FROM ADMISSIONS ad',
'JOIN PATIENTS p ON ad.PATIENT_ID = p.PATIENT_ID',
'JOIN ROOMS r ON ad.ROOM_ID = r.ROOM_ID',
'WHERE ad.STATUS = ''Admitted''',
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715115937Z')
,p_updated_on=>wwv_flow_imp.dz('20260715122624Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8708773739496501)
,p_name=>'P15_DISCHARGE_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8680656776626649)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8679070072626633)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'min_chars', '0')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715113705Z')
,p_updated_on=>wwv_flow_imp.dz('20260715122623Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8678932322626632)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8679147749626634)
,p_name=>'P15_ROOM_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8678893914626631)
,p_prompt=>'Room'
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT ROOM_NO || '' - '' || ROOM_TYPE || '' ($'' || DAILY_RATE || ''/day)'' AS DISPLAY_VALUE,',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8679869993626641)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Clear Admission Form'
,p_static_id=>'clear-admission-form'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items', 'P15_PATIENT_ID,P15_DOCTOR_ID,P15_ROOM_ID,P15_ADMISSION_DATE,P15_ADMISSION_REASON',
  'type', 'CLEAR_CACHE_FOR_ITEMS')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8679498800626637)
,p_internal_uid=>8679869993626641
,p_created_on=>wwv_flow_imp.dz('20260715114924Z')
,p_updated_on=>wwv_flow_imp.dz('20260715114924Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8709238605496506)
,p_process_sequence=>60
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Clear Discharge Admission Form'
,p_static_id=>'clear-discharge-admission-form'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items', 'P15_DISCHARGE_DATE',
  'type', 'CLEAR_CACHE_FOR_ITEMS')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8708827124496502)
,p_internal_uid=>8709238605496506
,p_created_on=>wwv_flow_imp.dz('20260715115937Z')
,p_updated_on=>wwv_flow_imp.dz('20260715115937Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8708961304496503)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Discharge Admission'
,p_static_id=>'discharge-admission'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'DECLARE',
'    l_room_id ADMISSIONS.ROOM_ID%TYPE;',
'BEGIN',
'    SELECT ROOM_ID INTO l_room_id',
'    FROM ADMISSIONS WHERE ADMISSION_ID = :P15_DISCHARGE_ADMISSION_ID;',
'',
'    UPDATE ADMISSIONS',
'    SET DISCHARGE_DATE = NVL(:P15_DISCHARGE_DATE, SYSDATE),',
'        STATUS = ''Discharged''',
'    WHERE ADMISSION_ID = :P15_DISCHARGE_ADMISSION_ID;',
'',
'    UPDATE ROOMS',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8708827124496502)
,p_process_success_message=>'Patient discharged successfully.'
,p_internal_uid=>8708961304496503
,p_created_on=>wwv_flow_imp.dz('20260715115937Z')
,p_updated_on=>wwv_flow_imp.dz('20260715115937Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8679627232626639)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Insert Admission'
,p_static_id=>'insert-admission'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
...
'    ) VALUES (',
'        :P15_PATIENT_ID, :P15_DOCTOR_ID, :P15_ROOM_ID, NVL(:P15_ADMISSION_DATE, SYSDATE),',
'        :P15_ADMISSION_REASON, ''Admitted''',
'    );',
'',
'    UPDATE ROOMS',
'    SET STATUS = ''Occupied''',
'    WHERE ROOM_ID = :P15_ROOM_ID;',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8679498800626637)
,p_process_success_message=>'Patient admitted successfully.'
,p_internal_uid=>8679627232626639
,p_created_on=>wwv_flow_imp.dz('20260715114924Z')
,p_updated_on=>wwv_flow_imp.dz('20260715114924Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
,p_page_component_map=>'18'
,p_created_on=>wwv_flow_imp.dz('20260715124019Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715125716Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8725723745768592)
...
'JOIN DEPARTMENTS d ON doc.DEPARTMENT_ID = d.DEPARTMENT_ID',
'JOIN APPOINTMENT_STATUSES st ON a.STATUS_ID = st.STATUS_ID',
'WHERE (:P16_DATE_FROM IS NULL OR a.APPOINTMENT_DATE >= :P16_DATE_FROM)',
'  AND (:P16_DATE_TO IS NULL OR a.APPOINTMENT_DATE <= :P16_DATE_TO)',
'  AND (:P16_DEPARTMENT_ID IS NULL OR d.DEPARTMENT_ID = :P16_DEPARTMENT_ID)',
'  AND (:P16_DOCTOR_ID IS NULL OR doc.DOCTOR_ID = :P16_DOCTOR_ID)',
'  AND (:P16_STATUS_ID IS NULL OR a.STATUS_ID = :P16_STATUS_ID)',
'ORDER BY a.APPOINTMENT_DATE DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P16_DATE_FROM,P16_DATE_TO,P16_DEPARTMENT_ID,P16_DOCTOR_ID,P16_STATUS_ID'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_units=>'INCHES'
,p_prn_paper_size=>'LETTER'
,p_prn_width=>11
...
,p_prn_border_color=>'#666666'
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260715124021Z')
,p_updated_on=>wwv_flow_imp.dz('20260715125202Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8725810170768592)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:XLSX:PDF'
,p_enable_mail_download=>'Y'
,p_internal_uid=>8725810170768592
,p_created_on=>wwv_flow_imp.dz('20260715124021Z')
,p_updated_on=>wwv_flow_imp.dz('20260715124031Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8728673046768627)
,p_db_column_name=>'APPOINTMENT_DATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Appointment Date'
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715124021Z')
,p_updated_on=>wwv_flow_imp.dz('20260715124021Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8727061025768613)
,p_db_column_name=>'APPOINTMENT_ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Appointment Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8729070990768629)
,p_db_column_name=>'APPOINTMENT_TIME'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Appointment Time'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8728229894768626)
,p_db_column_name=>'DEPARTMENT_NAME'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Department Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8727877156768624)
,p_db_column_name=>'DOCTOR_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Doctor Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8727408127768620)
,p_db_column_name=>'PATIENT_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Patient Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8729849059768632)
,p_db_column_name=>'REASON_FOR_VISIT'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Reason For Visit'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8729487541768631)
,p_db_column_name=>'STATUS_NAME'
,p_display_order=>7
,p_column_identifier=>'G'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8730280708769626)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'primary'
,p_status=>'PUBLIC'
...
,p_created_on=>wwv_flow_imp.dz('20260715124031Z')
,p_updated_on=>wwv_flow_imp.dz('20260715124031Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8724952737768439)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8709476729496508)
,p_plug_name=>'Filters'
,p_static_id=>'filters'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715125108Z')
,p_updated_on=>wwv_flow_imp.dz('20260715125108Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8710075443496514)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(8709476729496508)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8710198118496515)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_imp.id(8709476729496508)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8709906610496513)
,p_name=>'P16_DATE_FROM'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8709476729496508)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8709514586496509)
,p_name=>'P16_DATE_TO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8709476729496508)
,p_prompt=>'Date To'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'use_defaults', 'Y')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260715125108Z')
,p_updated_on=>wwv_flow_imp.dz('20260715125359Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8709613887496510)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8709738649496511)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8709856876496512)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8710445116496518)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
,p_static_id=>'clear'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items', 'P16_DATE_FROM,P16_DATE_TO,P16_DEPARTMENT_ID,P16_DOCTOR_ID,P16_STATUS_ID',
  'type', 'CLEAR_CACHE_FOR_ITEMS')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(8710198118496515)
,p_internal_uid=>8710445116496518
,p_created_on=>wwv_flow_imp.dz('20260715125620Z')
,p_updated_on=>wwv_flow_imp.dz('20260715125716Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
,p_page_component_map=>'18'
,p_created_on=>wwv_flow_imp.dz('20260715130006Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715131429Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8735179274887158)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8710592402496519)
,p_plug_name=>'Filters'
,p_static_id=>'filters'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8735999589887282)
...
'WHERE 1 = 1',
'  AND ( :P17_DOCTOR_FILTER IS NULL OR v.DOCTOR_ID = :P17_DOCTOR_FILTER )',
'  AND ( :P17_DEPT_FILTER   IS NULL OR d.DEPARTMENT_ID = :P17_DEPT_FILTER )',
'  AND ( :P17_VISIT_DATE    IS NULL OR v.VISIT_DATE = :P17_VISIT_DATE )',
'ORDER BY v.VISIT_DATE DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_units=>'INCHES'
...
,p_prn_border_color=>'#666666'
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260715130007Z')
,p_updated_on=>wwv_flow_imp.dz('20260715131429Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8736002585887282)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:XLSX:PDF'
,p_enable_mail_download=>'Y'
,p_internal_uid=>8736002585887282
,p_created_on=>wwv_flow_imp.dz('20260715130008Z')
,p_updated_on=>wwv_flow_imp.dz('20260715130751Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8738344404887300)
,p_db_column_name=>'DEPARTMENT_NAME'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Department Name'
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715130008Z')
,p_updated_on=>wwv_flow_imp.dz('20260715130008Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8739501998887304)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8737928272887298)
,p_db_column_name=>'DOCTOR_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Doctor Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8739975743887306)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8737567533887297)
,p_db_column_name=>'PATIENT_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Patient Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8739140430887303)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8738709240887301)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8737158314887293)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8742803112933625)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'primary'
,p_status=>'PUBLIC'
...
,p_created_on=>wwv_flow_imp.dz('20260715130751Z')
,p_updated_on=>wwv_flow_imp.dz('20260715130751Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8711064834496524)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_imp.id(8710592402496519)
,p_button_name=>'Clear'
,p_static_id=>'clear'
,p_show_as_disabled=>false
,p_button_action=>'REDIRECT_PAGE'
...
,p_grid_new_row=>'N'
,p_grid_new_column=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715131241Z')
,p_updated_on=>wwv_flow_imp.dz('20260715131241Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8710901184496523)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(8710592402496519)
...
,p_button_image_alt=>'Apply Filters'
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260715130722Z')
,p_updated_on=>wwv_flow_imp.dz('20260715130722Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8710711338496521)
,p_name=>'P17_DEPT_FILTER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(8710592402496519)
,p_prompt=>'Department'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8710655718496520)
,p_name=>'P17_DOCTOR_FILTER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8710592402496519)
,p_prompt=>'Doctor'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8710809733496522)
...
,p_page_component_map=>'18'
,p_created_on=>wwv_flow_imp.dz('20260715131629Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715132307Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8744522265985433)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8745383713985560)
...
'ORDER BY STOCK_STATUS DESC, m.MEDICINE_NAME'))
,p_plug_source_type=>'NATIVE_IR'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_units=>'INCHES'
,p_prn_paper_size=>'LETTER'
...
,p_prn_border_color=>'#666666'
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260715131630Z')
,p_updated_on=>wwv_flow_imp.dz('20260715132307Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8745472392985560)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:XLSX:PDF'
,p_enable_mail_download=>'Y'
,p_internal_uid=>8745472392985560
,p_created_on=>wwv_flow_imp.dz('20260715131630Z')
,p_updated_on=>wwv_flow_imp.dz('20260715132307Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8747430614985571)
,p_db_column_name=>'CATEGORY_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Category Name'
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715131630Z')
,p_updated_on=>wwv_flow_imp.dz('20260715131630Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8747817886985572)
,p_db_column_name=>'CURRENT_STOCK'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Current Stock'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8746684887985565)
,p_db_column_name=>'MEDICINE_ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Medicine Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8747019321985569)
,p_db_column_name=>'MEDICINE_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Medicine Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8748284403985574)
,p_db_column_name=>'REORDER_LEVEL'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Reorder Level'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8748694572985575)
,p_db_column_name=>'STOCK_STATUS'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Stock Status'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8749043232997221)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'primary'
,p_status=>'PUBLIC'
...
,p_created_on=>wwv_flow_imp.dz('20260715131827Z')
,p_updated_on=>wwv_flow_imp.dz('20260715131827Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
end;
...
,p_page_component_map=>'18'
,p_created_on=>wwv_flow_imp.dz('20260715131956Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260715132212Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8750997745006287)
...
,p_prn_border_color=>'#666666'
,p_ai_enabled=>false
,p_created_on=>wwv_flow_imp.dz('20260715131957Z')
,p_updated_on=>wwv_flow_imp.dz('20260715132212Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8751065314006287)
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:XLSX:PDF'
,p_enable_mail_download=>'Y'
,p_internal_uid=>8751065314006287
,p_created_on=>wwv_flow_imp.dz('20260715131957Z')
,p_updated_on=>wwv_flow_imp.dz('20260715132212Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8754265398006301)
...
,p_use_as_row_header=>'N'
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715131958Z')
,p_updated_on=>wwv_flow_imp.dz('20260715131958Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8752272646006291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8754551660006302)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8753041072006296)
,p_db_column_name=>'DOCTOR_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Doctor Name'
...
,p_available_clientside=>'N'
,p_created_on=>wwv_flow_imp.dz('20260715131957Z')
,p_updated_on=>wwv_flow_imp.dz('20260715131957Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8752681176006294)
,p_db_column_name=>'PATIENT_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Patient Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8753494422006297)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8753894594006299)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8754990253006304)
,p_db_column_name=>'STATUS'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8755374296007453)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'primary'
,p_status=>'PUBLIC'
...
,p_created_on=>wwv_flow_imp.dz('20260715132009Z')
,p_updated_on=>wwv_flow_imp.dz('20260715132009Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8750169316006169)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
,p_created_on=>wwv_flow_imp.dz('20260713053441Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260713053441Z')
,p_created_by=>'ADMIN'
,p_last_updated_by=>'ADMIN'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7772023925241274)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7773677796241292)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(7772023925241274)
,p_button_name=>'LOGIN'
,p_static_id=>'login'
,p_show_as_disabled=>false
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7772956648241288)
,p_name=>'P9999_PASSWORD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(7772023925241274)
,p_prompt=>'Password'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7773306285241291)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7772504309241286)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7777743149241305)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>7777743149241305
,p_created_on=>wwv_flow_imp.dz('20260713053441Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053441Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7777389106241304)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>7777389106241304
,p_created_on=>wwv_flow_imp.dz('20260713053441Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053441Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7774002796241296)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>7774002796241296
,p_created_on=>wwv_flow_imp.dz('20260713053441Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053441Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(7775017066241303)
,p_page_process_id=>wwv_flow_imp.id(7774002796241296)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(7775543480241303)
,p_page_process_id=>wwv_flow_imp.id(7774002796241296)
,p_page_id=>9999
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(7774528634241300)
,p_page_process_id=>wwv_flow_imp.id(7774002796241296)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7775929500241303)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'type', 'PLSQL_PACKAGE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>7775929500241303
,p_created_on=>wwv_flow_imp.dz('20260713053441Z')
,p_updated_on=>wwv_flow_imp.dz('20260713053441Z')
,p_created_by=>'ADMIN'
,p_updated_by=>'ADMIN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(7776951850241304)
,p_page_process_id=>wwv_flow_imp.id(7775929500241303)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
,p_data_type=>'BOOLEAN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(7776476880241304)
,p_page_process_id=>wwv_flow_imp.id(7775929500241303)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
